...
export class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=69a518f2491f49568abf72371ef90865&page=${this.state.page}&pageSize=${this.props.pageSize}`
